...
class TestChapter02ex03:
    @pytest.mark.solution_runner(["-10", "0", "21"], 0.1)
...
class TestChapter02ex05:
    @pytest.mark.solution_runner(["50", "100", "-21", "111"], 0.1)
...
class TestChapter02ex06:
    @pytest.mark.solution_runner(["3", "23", "-21", "111"], 0.1)
...
class TestChapter02ex07:
    @pytest.mark.solution_runner(["красный", "желтый", "зеленый"], 0.1)
...
class TestChapter02ex08:
    @pytest.mark.solution_runner([("21", "Y"), ("21", "N"), ("-14", "q")], 0.1)
...
class TestChapter02ex10:
    @pytest.mark.solution_runner(
        [("True", "True"), ("True", "False"), ("False", "G!!"), ("True", "Mur")], 0.1
    )
...
class TestChapter02ex11:
    @pytest.mark.solution_runner([("4", "5"), ("1", "9"), ("3", "5"), ("5", "2")], 0.1)
...
class TestChapter02ex12:
    @pytest.mark.solution_runner(
        [("4", "5", "6"), ("4", "15", "3"), ("14", "5", "6"), ("4", "5", "16")], 0.1
    )
